        ...
        <div className="card custom-card shadow">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <ul className="nav nav-pills" id="clientTabs" role="tablist">
                            <li className="nav-item" role="presentation">
                                <button className="nav-link active" id="client1-tab" data-bs-toggle="pill" data-bs-target="#client1" type="button" role="tab">
                                    Default Client
                                    <span className="badge bg-danger ms-2">OFF</span>
                                </button>
                            </li>
                        </ul>
                        <button className="btn btn-sm btn-outline-secondary" id="addClientBtn">
                ...
                <div className="card-body">
                    <div className="tab-content" id="clientTabContent">
                        <div className="tab-pane fade show active" id="client1" role="tabpanel">
                                    ...
                                    <div className="card custom-card mb-4">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="d-grid gap-2">
                                                ...
                                                <button className="btn btn-secondary" id="reconnectBtn">
                                                    <i className="bi bi-arrow-clockwise"></i> Reconnect
                                                </button>
                                            </div>
                                        </div>
                                    </div>
